			...
			<div className="main-container">
				...
				<div className="main-bottom">
					...
					<div className="bottom-info">
						<p>
							Interactive Chat-bot may display inaccurate info, including about people, so
							double-check its responses. Your privacy & Chat-bot Apps
						</p>
					</div>
				</div>
			</div>
